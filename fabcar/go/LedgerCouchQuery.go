...
func allUserQueryVAlueForQueryString(stub shim.ChaincodeStubInterface, queryString string)([]byte,error){
	...
	userArray := []UserCertificate{}

	x, _:= resultIterator.Next()
	for resultIterator.HasNext(){

		var userData UserCertificate
		_=json.Unmarshal(x.Value,&userData)
	...
	resultArrayJjson, _:=json.Marshal(userArray)

	return (resultArrayJjson), nil
}
